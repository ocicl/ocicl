...
Restrictions apply to allowed PLACEs by implementation:
             ...
             Allegro CCL Clasp ECL LispWorks Mezzano SBCL CMUCL CL-Amiga
CAR             X          X    X     X         X     X     X      X
CDR             X          X    X     X         X     X     X      X
FIRST                      X    X               X     X     X      X
REST                       X    X               X     X     X      X
SVREF           X     X    X    X     X         X     X     X      X
SYMBOL-PLIST    X          X    X                     X     X
SYMBOL-VALUE    X          X    X     X         X     X     X      X
SLOT-VALUE      X*         X    X*    X*        X     X*    X      X
MEMREF          X                                     X*
MEMREF-INT      X                                     X*
struct-slot     X     X*   X    X*    X         X     X*    X      X
special-var     X     X    X    X     X         X     X     X      X
custom                     X    X     X         X     X     X
...
# CL-Amiga                                       (MP:COMPARE-AND-SWAP)
- On the host a native compare-exchange is used; on the single-core
  AmigaOS/MorphOS targets a Forbid()/Permit() window is used instead,
  so atomic operations are blocking there.")
