...
(define-api make-readtable
  ...
  > _Note:_ An empty readtable is a readtable where each character's
  > syntax is the same as in the _standard readtable_ except that each
