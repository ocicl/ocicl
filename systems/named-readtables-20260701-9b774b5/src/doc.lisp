...
(pax:defsection @acknowledgements (:title "Acknowledgements")
...
(pax:defsection @overview (:title "Overview")
  (@api-notes pax:section)
  (@api-idiosyncrasies pax:section)
  (@preregistered pax:section)
  (@examples pax:section))

(pax:defsection @api-notes
...
(pax:defsection @api-idiosyncrasies
  ...
  - **DEFREADTABLE does not have compile-time effects.**
...
(pax:defsection @examples (:title "Examples" :export nil)
  "```commonlisp
